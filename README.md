...
#### [2] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [3] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [4] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [5] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [6] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [7] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [8] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [9] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [10] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [11] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [12] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [13] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [15] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [16] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [17] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [18] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [19] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
- **🧑‍🔬 作者**：BoCheng Li, WenJuan Zhang, Bing Zhang, YiLing Yao, YaNing Wang
- **🏫 单位**: Aerospace Information Research Institute
- **🔗 链接**：[[中英摘要](./abs/2503.00848.md)] [[arXiv:2503.00848](https://arxiv.org/abs/2503.00848)] [Code]
- **📝 说明**：

#### [20] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [21] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [23] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [24] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [25] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [26] Seeing A 3D World in A Grain of Sand
...
#### [27] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [28] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [29] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [30] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [31] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [32] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [33] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [35] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [37] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [38] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [39] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [40] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [41] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [42] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [43] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [44] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [45] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [46] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [47] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [48] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [49] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [50] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [51] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [52] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [53] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [54] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [55] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [56] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [57] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [58] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [59] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [60] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [61] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [62] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [63] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [64] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [65] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [66] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [67] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [68] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [69] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [70] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [71] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [72] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [73] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [74] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [75] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [76] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [77] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [78] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [79] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [80] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [81] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [82] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [83] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [84] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [85] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [87] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [88] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [89] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [90] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [91] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [92] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [93] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [94] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [95] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [96] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [97] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [98] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [99] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [100] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [101] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [102] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [103] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [104] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [105] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [106] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [107] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [108] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [109] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [110] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [111] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [112] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [113] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [114] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [115] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [116] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [117] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [118] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [119] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [120] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [121] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [122] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [123] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [124] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [125] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [126] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [127] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [128] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [129] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [130] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [131] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [132] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [134] Gaussian Masked Autoencoders
...
#### [135] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [136] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [137] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [138] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [139] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [140] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [141] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [142] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [143] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [144] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [145] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [146] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [147] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [148] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [149] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [150] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [151] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [152] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [153] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [154] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [155] Reflective Gaussian Splatting
...
#### [156] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [157] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [158] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [159] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [160] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [161] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [162] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [163] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [164] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [165] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [166] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [167] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [168] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [169] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [170] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [171] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [172] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [173] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [174] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [175] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [176] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [177] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [178] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [179] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [180] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [181] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [182] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [183] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [184] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [185] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [186] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [187] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [188] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [189] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [190] EOGS: Gaussian Splatting for Earth Observation
...
#### [191] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [192] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [193] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [194] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [195] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [196] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [197] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [198] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [199] Deformable Radial Kernel Splatting
...
#### [200] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [201] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [202] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [203] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [204] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [205] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [206] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [207] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [208] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [209] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [210] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [211] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [212] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [213] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [214] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [215] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [216] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [217] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [218] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [219] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [220] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [221] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [222] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [223] GASP: Gaussian Avatars with Synthetic Priors
...
#### [224] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [225] Faster and Better 3D Splatting via Group Training
...
#### [226] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [227] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [228] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [229] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [230] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [231] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [232] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [233] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [234] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [235] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [236] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [237] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [238] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [239] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [240] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [241] Street Gaussians without 3D Object Tracker
...
#### [242] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [243] Extrapolated Urban View Synthesis Benchmark
...
#### [244] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [245] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [246] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [247] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [248] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [249] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [250] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [251] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [252] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [253] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [254] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [255] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [256] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [257] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [258] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [259] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [260] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [261] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [262] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [263] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [264] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [265] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [266] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [267] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [268] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [269] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [270] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [271] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [272] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [273] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [274] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [275] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [276] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [277] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [278] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [279] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [280] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [281] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [282] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [283] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [284] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [285] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [286] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [287] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [288] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [289] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [290] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [291] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [292] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [293] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [294] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [295] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [296] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [297] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [298] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [299] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [300] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [301] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [302] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [303] Neural Surface Priors for Editable Gaussian Splatting
...
#### [304] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [305] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [306] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [307] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [308] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [309] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [310] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [311] Geometry Field Splatting with Gaussian Surfels
...
#### [312] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [313] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [314] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [315] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [316] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [317] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [318] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [319] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [320] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [321] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [322] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [323] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [324] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [325] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [326] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [327] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [328] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [329] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [330] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [331] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [332] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [333] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [334] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [335] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [336] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [337] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [338] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [339] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [340] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [341] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [342] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [343] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [344] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [345] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [346] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [347] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [348] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [349] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [350] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [351] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [352] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [353] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [354] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [355] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [356] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [357] VeGaS: Video Gaussian Splatting
...
#### [358] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [359] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [360] Efficient Density Control for 3D Gaussian Splatting
...
#### [361] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [362] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [363] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [364] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [365] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [366] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [367] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [368] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [369] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [370] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [371] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [372] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [373] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [374] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [375] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [376] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [377] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [378] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [379] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [380] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [381] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [382] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [383] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [384] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [385] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [386] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [387] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [388] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [389] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [390] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [391] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [392] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [393] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [394] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [395] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [396] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [397] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [398] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [399] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [400] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [401] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [402] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [403] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [404] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [405] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [406] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [407] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [408] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [409] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [410] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [411] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [412] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [413] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [414] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [415] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [416] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [417] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [418] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [419] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [420] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [421] 3D Vision-Language Gaussian Splatting
...
#### [422] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [423] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [424] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [425] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [426] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [427] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [428] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [429] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [430] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [431] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [432] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [433] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [434] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [435] Variational Bayes Gaussian Splatting
...
#### [436] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [437] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [438] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [439] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [440] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [441] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [442] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [443] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [444] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [445] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [446] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [447] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [448] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [449] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [450] RNG: Relightable Neural Gaussians
...
#### [451] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [452] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [453] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [454] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [455] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [456] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [457] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [458] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [459] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [460] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [461] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [462] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [463] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [464] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [465] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [466] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [467] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [468] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [469] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [470] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [471] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [472] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [473] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [474] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [475] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [476] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [477] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [478] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [479] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [480] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [481] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [482] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [483] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [484] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [485] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [486] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [487] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [488] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [489] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [490] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [491] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [492] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [493] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [494] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [495] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [496] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [497] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [498] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [499] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [500] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [501] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [502] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [503] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [504] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [505] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [506] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [507] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [508] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [509] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [510] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [511] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [512] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [513] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [514] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [515] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [516] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [517] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [518] OmniRe: Omni Urban Scene Reconstruction
...
#### [519] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [520] G-Style: Stylized Gaussian Splatting
...
#### [521] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [522] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [523] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [524] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [525] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [526] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [527] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [528] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [529] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [530] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [531] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [532] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [533] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [534] Subsurface Scattering for 3D Gaussian Splatting
...
#### [535] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [536] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [537] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [538] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [539] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [540] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [541] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [542] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [543] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [544] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [545] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [546] 3D Gaussian Editing with A Single Image
...
#### [547] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [548] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [549] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [550] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [551] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [552] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [553] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [554] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [555] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [556] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [557] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [558] IG-SLAM: Instant Gaussian SLAM
...
#### [559] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [560] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [561] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [562] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [563] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [564] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [565] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [566] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [567] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [568] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [569] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [570] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [571] Gaussian Splatting Lucas-Kanade
...
#### [572] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [573] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [574] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [575] PICA: Physics-Integrated Clothed Avatar
...
#### [576] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [577] Gaussian Eigen Models for Human Heads
...
#### [579] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [580] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [581] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [582] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [583] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [584] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [585] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [586] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [587] Lightweight Predictive 3D Gaussian Splats
...
#### [588] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [589] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [590] On Scaling Up 3D Gaussian Splatting Training
...
#### [591] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [592] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [593] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [594] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [595] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [596] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [597] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [598] E2GS: Event Enhanced Gaussian Splatting
...
#### [599] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [600] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [601] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [602] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [603] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [604] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [605] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [606] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [607] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [608] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [609] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [610] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [611] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [612] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [613] Generalizable Human Gaussians from Single-View Image
...
#### [614] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [615] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [616] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [617] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [618] Localized Gaussian Point Management
...
#### [619] Gaussian Representation for Deformable Image Registration
...
#### [620] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [621] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [622] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [623] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [624] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [625] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [626] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [627] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [628] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
